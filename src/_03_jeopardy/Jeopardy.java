...
public class Jeopardy implements ActionListener {
	...
	private JButton thirdButton, fourthButton, fithButton, sixthButton;
	...
	public void run() {
		...
		frame.setTitle("This is the Game of Jeopardy");
		// 3. Create a JPanel variable to hold the header using the createHeader method
		JPanel header = createHeader("Jeoparty");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==firstButton) {
			askQuestion("What is the average wing velocity of a swallow","Which one? African or European?",100);
			firstButton.setText("");
		}
		...
		if(e.getSource()==thirdButton) {
			askQuestion("What is Mitchel's game called","Globglogabgalab",400);
			thirdButton.setText("");
		}
			// Call the askQuestion() method with a harder question
		if(e.getSource()==fourthButton) {
			askQuestion("What is Garrett's game called","Ninjoreo",600);
			fourthButton.setText("");
		}
		if(e.getSource()==fithButton) {
			askQuestion("What my name","Beckham",800);
			fithButton.setText("");
		}
		if(e.getSource()==sixthButton) {
			askQuestion("say hi","hi",1000);
			sixthButton.setText("");
		}
